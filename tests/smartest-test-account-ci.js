...
const index=read("index.html"),account=read("account.js"),history=read("history.js"),platform=read("test-platform.js"),core=read("test-platform-core.js"),backend=read("supabase/functions/quiz-results-service/index.ts");
must(/function showMyStatistics/.test(read("results-menu.js")),"statistics navigation is active");
...
must(/Results are published at Previous Answer/.test(read("results-menu.js")),"Previous Answer publication rule is preserved");
